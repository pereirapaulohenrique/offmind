    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-surface)] shadow-2xl">
              {/* Header */}
                  ...
                  <div className="space-y-2">
                    ...
                    {actions.map((action) => (
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg border border-[var(--border-default)] p-3 text-left transition-colors hover:bg-[var(--bg-hover)] hover:border-[var(--border-emphasis)]"
                      >
                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--bg-hover)]">
                          <action.icon className="h-5 w-5 text-[var(--text-muted)]" />
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {result && (
                      <div className="rounded-lg bg-[var(--bg-hover)] p-4">
                        <p className="text-sm font-medium text-[var(--text-muted)] mb-2">Result:</p>
