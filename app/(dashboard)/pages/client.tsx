    ...
    <div className="flex h-full flex-col">
      ...
      <div className="px-6 py-6 sm:px-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-[var(--text-primary)] sm:text-3xl" style={{ letterSpacing: 'var(--tracking-tight)' }}>Pages</h1>
                ...
                {sortedPages.map((page) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group relative rounded-xl bg-[var(--bg-surface)] p-5 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] cursor-pointer transition-[box-shadow,transform] duration-200 hover:-translate-y-px"
