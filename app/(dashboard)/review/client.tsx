...
export function ReviewPageClient({
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Page header */}
      <div className="flex-shrink-0 px-6 py-6 sm:px-8">
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-2xl font-semibold text-[var(--text-primary)] sm:text-3xl" style={{ letterSpacing: 'var(--tracking-tight)' }}>Review</h1>
...
function ProcessItemCard({
  ...
  return (
    <div
      className={cn(
        'group relative rounded-xl bg-[var(--bg-surface)] shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-[box-shadow,transform] duration-200 hover:-translate-y-px',
        compact ? 'p-3' : 'p-4'
      )}
    >
